...
export class PureMobileView extends React.PureComponent<
  IMobileViewStore & IMobileViewDispatchProps,
  IMobileViewState
> {
  ...
  public render() {
    ...
    return (
      <div className="main-mobile-view">
        <Navbar className="bp3-dark" style={{ zIndex: 10 }}>
          ...
          <NavbarGroup align={Alignment.RIGHT}>
            <Popover>
              <Button
                icon="user"
                text={this.props.currentUser.name}
              ...
              <Menu>
                <MenuItem
                  ...
                  onClick={this.handleOpenAccountDetails}
                />
                <MenuItem
                  icon="log-out"
                  text="Sign out"
            ...
            <UpdateUser
              isOpen={this.state.accountDetailsDialogOpen}
              onClose={this.handleCloseAccountDetails}
            />
          </NavbarGroup>
        </Navbar>
        <DialogWrapper
          className="main-mobile-button"
        ...
        />
        <EventList
          className="mobile-current-events"
  ...
  private handleOpenAccountDetails = () =>
    this.setState({ accountDetailsDialogOpen: true });
  private handleCloseAccountDetails = () =>
    this.setState({ accountDetailsDialogOpen: false });
...
export const MobileView = connect(
  mapStoreToProps,
  mapDispatchToProps
)(PureMobileView);
