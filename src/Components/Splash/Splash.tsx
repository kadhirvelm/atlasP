            ...
            <div>
                <div className="splash-main-page">
                    ...
                    <div className="splash-contents">
                        <h4 className="splash-subheader">Join your friend, {from}, on AtlasP</h4>
                        <div className="splash-main-content">
                            <div className="splash-bullet border-right">
                                <div className="splash-bullet-header">Meet friends with a single text.</div>
                                <div className="splash-bullet-text">AtlasScheduler – automated scheduling.</div>
                            </div>
                            <div className="splash-bullet">
                                <div className="splash-bullet-header">Understand your social time.</div>
                                <div className="splash-bullet-text">AtlasGraph – relationship visualization.</div>
                            </div>
                        </div>
                        <h4 className="splash-subheader">Stay in touch with your friends. </h4>
                        <div className="claim-button">
                            <Button  intent={Intent.PRIMARY} large={true} onClick={this.moveToMainPage} text="Claim your account" />
                        </div>
                    </div>
                </div>
                ...
                <div className="splash-credit">
                    Photo by <a style={ { color: "white" } } target="_blank" href="https://unsplash.com/@billy_pasco">Billy Pasco</a> on Unsplash
                </div>
            </div>
        )
    }
