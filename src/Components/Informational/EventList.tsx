...
class PureEventList extends React.PureComponent<IEventListProps & IEventListProps & IEventsListStoreProps & IEventListDispatchProps> {
    ...
    private maybeRenderEvents() {
        ...
        return (
            <div className="flexbox-events overflow-y">
                ...
                <UpdateEvent isOpen={this.props.selectedEvent !== undefined} onClose={this.clearSelectedEvent} />
            </div>
        )
    }
...
export const EventList = connect(mapStateToProps, mapDispatchToProps)(PureEventList);
